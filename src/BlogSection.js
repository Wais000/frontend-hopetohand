      ...
      <div className={styles.container}>
        <div className={styles.box}>
          ...
          <div className={styles.content}>
            ...
            <p>
              Center for Migration and Integration
              <br />
              Address: <span>Stettiner Str. 12, 13357 Berlin</span>
            ...
            <p>
              ...
              <br />
              Address: <span>Schwiebusser Str. 18, 10965 Berlin</span>
            ...
            <p>
              ...
              <br />
              Address: <span>Potsdamer Str. 65, 10785 Berlin</span>
              <br /> Contact: <span>+49 30901723163</span> <br />
              website:{" "}
              <span>https://www.integrationsbeauftragte.berlin.de/</span>
            </p>

            <p>
              Gesellschaftliche Integration von Menschen mit Beh GIB e.V.
              <br />
              Address: <span>Tuchmacherweg 8, 13158 Berlin</span>
        ...
        <div className={styles.box}>
          ...
          <div className={styles.content}>
            ...
            <p>
              Outdoor Free Fitness Parc
              <br /> Address: <span>Viktoriapark, 12163 Berlin</span>
              <br /> Contact: <span>Open 24h/24</span>
            </p>

            <p>
              Berlin Rent a Bike - Free Tours
              <br /> Address: <span>Rathausstraße 4, 10178 Berlin</span>
              <br /> Contact: <span>+49 1635120124</span> <br />
              website: <span>https://www.iloveberlintours.com/</span>
            </p>

            <p>
              Freeletics Fitness Area - Outdoor Calisthenic
              <br /> Address: <span>Monbijoustraße 3B, 10117 Berlin</span>
              <br /> Contact: <span>Open 24h/24</span>
            </p>

            <p>
              Adidas Open Playground - Outdoor Parc
              <br /> Address:{" "}
              <span>Brandenburgische Str. 51, 10707 Berlin</span>
              <br /> Contact: <span>+49 17631568519</span>
            </p>

            <p>
              Calisthenics Park Gleisdreieck - Athletic Parc
              <br /> Address: <span>10963 Berlin</span>
              <br />
              website: <span>https://www.calisthenics-parks.co/</span>
              <br /> Contact: <span>Open 24h/24</span>
            </p>
          </div>
        </div>
        <div className={styles.box}>
          ...
          <div className={styles.content}>
            ...
            <p>
              Bike & Tour Rental
              <br />
              Address: <span>Poststraße 11, 10178 Berlin</span>
              <br /> Contact: <span>03028704492</span> <br />
              website: <span>www.fahrradtouren-berlin.com</span>
            </p>

            <p>
              Free Tours by Foot - Visit Agency
              <br />
              Address: <span> Berlin</span>
              <br /> Contact: <span>+49 1747803618</span> <br />
              website: <span>https://freetoursbyfoot.com/</span>
            </p>

            <p>
              BSANDEMANs - Free Walking Tour
              <br />
              Address: <span> Berlin</span>
              <br /> Contact: <span>+49 3051050030</span> <br />
              website:{" "}
              <span>https://www.neweuropetours.eu/berlin-walking-tours</span>
            </p>

            <p>
              Original Berlin Tours
              <br />
              Address: <span>Alexanderpl. 7, 10178 Berlin</span>
              <br /> Contact: <span>+49 15783893416</span> <br />
              website: <span>https://www.originalberlintours.com/</span>
            </p>
          </div>
        </div>
      </div>
