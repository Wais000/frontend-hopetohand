...
<p className={styles.formHeader}>Please select the top left button on the map, and check the boxes in order to view our partners locations!</p> 
...
<Card style={{ boxShadow: "#EAD49C 0px 2px 2px 1px", width: '15rem', height:'12rem', backgroundImage:`url(${MedicalImage})`, backgroundPosition:'center', backgroundSize:"cover", fontFamily:'Montserrat', margin: '10px',  alignSelf: 'stretch'
}}>
      <Card.Body>
    ...
    <Card style={{  boxShadow: "#EAD49C 0px 2px 2px 1px",width: '15rem', height:'12rem', backgroundImage:`url(${FoodImage})`, backgroundPosition:'center', backgroundSize:"cover", fontFamily:'Montserrat', margin: '10px', position: 'relative' }}>
      <Card.Body>
    ...
    <Card style={{ width: '15rem', height:'12rem',boxShadow: "#EAD49C 0px 2px 2px 1px", backgroundImage:`url(${IntergrationCourse})`, backgroundPosition:'center', backgroundSize:"cover", fontFamily:'Montserrat', margin: '10px', position: 'relative' }}>
      <Card.Body>
    ...
    <Card style={{boxShadow: "#EAD49C 0px 2px 2px 1px", width: '15rem', height:'12rem', backgroundImage:`url(${CheapCloths})`, backgroundPosition:'center', backgroundSize:"cover", fontFamily:'Montserrat', margin: '10px', position: 'relative' }}>
      <Card.Body>
    ...
    <Card style={{boxShadow: "#EAD49C 0px 2px 2px 1px", width: '15rem', height:'12rem', backgroundImage:`url(${SocialService})`, backgroundPosition:'center', backgroundSize:"cover", fontFamily:'Montserrat', margin: '10px', position: 'relative' }}>
      <Card.Body>
    ...
    <Card style={{boxShadow: "#EAD49C 0px 2px 2px 1px", width: '15rem', height:'12rem', backgroundImage:`url(${DrivingSchools})`, backgroundPosition:'center', backgroundSize:"cover", fontFamily:'Montserrat', margin: '10px', position: 'relative' }}>
      <Card.Body>
    ...
    <Card style={{boxShadow: "#EAD49C 0px 2px 2px 1px", width: '15rem', height:'12rem', backgroundImage:`url(${Law})`, backgroundPosition:'center', backgroundSize:"cover", fontFamily:'Montserrat', margin: '10px', position: 'relative' }}>
      <Card.Body>
    ...
    <Card style={{ boxShadow: "#EAD49C 0px 2px 2px 1px",width: '15rem', height:'12rem', backgroundImage:`url(${Sport})`, backgroundPosition:'center', backgroundSize:"cover", fontFamily:'Montserrat', margin: '10px', position: 'relative' }}>
      <Card.Body>
    ...
    <Card style={{ boxShadow: "#EAD49C 0px 2px 2px 1px",width: '15rem', height:'12rem', backgroundImage:`url(${Park})`, backgroundPosition:'center', backgroundSize:"cover", fontFamily:'Montserrat', margin: '10px', position: 'relative'}}>
      <Card.Body>
        <Card.Title style={{ color: 'white', fontSize:'30px'}}><TbOlympics/></Card.Title>
    ...
    <Card style={{ boxShadow: "#EAD49C 0px 2px 2px 1px",width: '15rem', height:'12rem', backgroundImage:`url(${corona})`, backgroundPosition:'center', backgroundSize:"cover", fontFamily:'Montserrat', margin: '10px', position: 'relative' }}>
      <Card.Body>
        <Card.Title style={{ color: 'white', fontSize:'30px'}}><TbOlympics/></Card.Title>
